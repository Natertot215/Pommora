...
// renderer CSS vars or vanilla-extract tokens, so this plain constant is the seam both sides share
// — main's BrowserWindow backgroundColor, color.css.ts's background.window token, and styles.css's
// --main-bg all trace back here.
