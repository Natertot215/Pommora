...
/** The dark seam is load-bearing at one square: the brightest grey's ring resolves to label-primary, which IS that square's fill, so without it the two merge into a single blob. */
