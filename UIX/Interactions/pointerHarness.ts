// jsdom has no PointerEvent constructor, measures every rect as zero, and lacks pointer capture — these stubs cover those three gaps. Geometry truth stays with the CDP passes.
...
export function firePointer(
  ...
  // A zero-buttons move means the release was missed, which the gesture skeleton treats as an abort.
