...
/** A surface that cannot tell whether the target is already open passes nothing. */
...
/** The same verb names what it acts on: a row says "Unlock", the button beside it "Unlock tile". */
