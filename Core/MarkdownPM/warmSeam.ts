...
/** A seam over an in-memory cache: a page edited since the capture invalidates the whole entry,
 *  since selection and history are positions into a document that no longer exists. */
