 ...
 *  `GlassSurface` is only that fill: a window has to hold its own content legible over whatever it
 *  floats above, where a menu is gone before that matters. `GlassPane` is the tier below both,
