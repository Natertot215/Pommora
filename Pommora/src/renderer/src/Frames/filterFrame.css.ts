// The FilterFrame's rule rows + field variants. A row is a free flex run — connector · what ·
 ...
 *  rather than pinned as a footing, so adding reads as extending the list rather than a frame action. */
