...
import { createPage, updatePageProperty } from '../crud/page'
import { createAgendaItem, updateAgendaProperty } from '../crud/agendaEntity'
...
describe('rebuildIndex (cold build)', () => {
  it('populates every table from the canonical files', async () => {
    ...
    // property_definitions mirrors the nexus-wide registry only — agenda config defs stay out
