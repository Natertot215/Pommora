// The local heading-fold store: `.nexus/folds.json`, keyed by page id. Per-page editor UI
// state lives here — NOT in frontmatter (keeps the portable `.md` clean, no Pommora noise
// leaking to Obsidian) and NOT in the SQLite index. Inside `.nexus/` it's already outside the
// content walk and any future body-sync — per-machine by construction.
