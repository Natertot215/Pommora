...
- **The clear chrome (Nathan's directive, 08-19, superseding his 08-18 tint directive):** the browser toolbar is *literally* clear — the strip paints nothing and the guest runs the full window beneath it, so the chrome wears the site's color by showing it. The reported theme-color now only judges label contrast (`is-light-chrome` flips the floating labels dark over a light site).
