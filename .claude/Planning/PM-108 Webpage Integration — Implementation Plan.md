...
- **The see-through chrome (Nathan's directive, 08-19, settled over two refinements):** the browser strip paints nothing of its own — the window glass shows through — and the page sits below it, never beneath it (`6498a4b8`). The theme-color tint and the label-contrast flip that preceded it were removed with the final reading.
