...
- **The setting ships as "Show Footnotes By Default", not "Default Visibility".** F-4 and R10 name it the second way and Task 10 shipped it the first. The shipped label is the clearer one and is what `ConfigurationPM.md` has always documented, so the claim was corrected rather than the UI renamed. *Nathan's to overturn if he wants the spec's wording.*
