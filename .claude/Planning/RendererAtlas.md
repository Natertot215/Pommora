...
- **The convergent value.** `--labels-gap` (4px in three homes: `table-tokens.css:16`, `pageProperties.css.ts:48`, `pageWindow.css:95`). *Recommendation:* absorb into `Tokens/`.
