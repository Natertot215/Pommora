...
- [ ] **Phase 3** — Rendering and the settings
  ...
  - [ ] Task 3.3 — The decoration draws `Page ┃ §Heading` and the missing heading
  - [ ] Task 3.4 — The stylesheet
  - [ ] Task 3.5 — Resting cells and the click selectors
  - [ ] Task 3.6 — `§` becomes `#` inside a link
  - [ ] Review Checkpoint
...
- [ ] **Phase 6** — The rename cascade
  ...
  - [ ] Task 6.3 — `connections:headingRenamed` and the main-side cascade
  - [ ] Task 6.4 — The external diff
  - [ ] Review Checkpoint
- [ ] `[Stop: Nathan renames a heading with links on two pages and in Obsidian]`
- [ ] **Phase 7** — In-Page Heading Resolution
  - [ ] Task 7.1 — Section runs
  - [ ] Task 7.2 — The bare run draws and travels
  - [ ] Task 7.3 — The `§` picker on the keystroke
  - [ ] Review Checkpoint
