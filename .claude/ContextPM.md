...
- [ ] **The vocabulary — [[DesignTermsV2]]**, four sessions: Menus, Panes, Frames, the side slot. Menus first; it is the largest count and every row is a rename the typecheck polices.
