...
- **The property-bucket "+"** — the table's structural bands create (→ [[TableViewPM]]); property and ungrouped bands offer no affordance, since a bucket can't infer a create location. One waits on a location ruling.
