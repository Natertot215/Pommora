...
│   ├── nexus.db                         | • Device-local operational state, the content index, and the sync base record
│   ├── versions.db                      | • Device-local page file history and sync captures
