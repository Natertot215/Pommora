...
| Pane Clearance    | `--sidebar-clearance` · `--side-pane-clearance`                                                    | `--app-inset` + the pane's width, `0px` when the pane is away; a consumer pads `calc(clearance + gap)` with one of the three gaps above (`styles.css`)                                                                                                                                                    |
