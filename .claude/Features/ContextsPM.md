...
- **SpaceView** — selecting a Space renders its banner scaffold over its block surface, the second block host beside the Homepage, with a per-Space board lock and its Subfield breadcrumb.
